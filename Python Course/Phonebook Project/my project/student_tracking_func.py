...
#
# Purpose:      A mock Phonebook Demonstrating OOP, Tkinter GUI module, SQLite3,
...
def first_run(self):
    ...
    with conn:
        ...
        if count < 1:
            cur.execute("""INSERT INTO tbl_students (col_fname,col_lname,col_fullname,col_phone,col_email,col_course) VALUES (?,?,?,?,?,?)""", ('John','Doe','John Doe','111-111-1111','jdoe@email.com','Physics'))
            conn.commit()
    conn.close()
