...
class ParentWindow(Frame):
    def __init__(self, master, *args, **kwargs):
        ...
        func.center_window(self,500,400)
        self.master.title("Information Tracking")
        ...
        filemenu.add_command(label="Exit", underline=1,accelerator="Ctrl+Q",command=lambda: func.ask_quit(self))
